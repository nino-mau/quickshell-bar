...
Singleton {
    ...
    readonly property string icon: hasWeather ? weatherIcon(weatherCode, isDay) : Commons.Icons.weatherAlert
    ...
    function weatherIcon(code: int, day: bool): string {
        if (code === 0 || code === 1) {
            return day ? Commons.Icons.weatherSunny : Commons.Icons.weatherNight;
        }
        if (code === 2) {
            return Commons.Icons.weatherPartlyCloudy;
        }
        if (code === 3) {
            return Commons.Icons.weatherCloudy;
        }
        if (code === 45 || code === 48) {
            return Commons.Icons.weatherFog;
        }
        if ((code >= 51 && code <= 67) || (code >= 80 && code <= 82)) {
            return code >= 65 || code === 82 ? Commons.Icons.weatherPouring : Commons.Icons.weatherRainy;
        }
        if ((code >= 71 && code <= 77) || code === 85 || code === 86) {
            return Commons.Icons.weatherSnowy;
        }
        if (code === 95) {
            return Commons.Icons.weatherLightning;
        }
        if (code === 96 || code === 99) {
            return Commons.Icons.weatherHail;
        }
        return Commons.Icons.weatherAlert;
    }
